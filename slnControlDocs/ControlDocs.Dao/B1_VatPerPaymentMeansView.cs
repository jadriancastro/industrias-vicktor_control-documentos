...
namespace ControlDocs.Dao
{
    ...
    public partial class B1_VatPerPaymentMeansView
    {
        ...
        public string DocLineType { get; set; }
        ...
        public string PaidDocObjType { get; set; }
        public Nullable<int> PaidDocAbsEntry { get; set; }
        public Nullable<int> PayObjType { get; set; }
