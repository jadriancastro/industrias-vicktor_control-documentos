...
namespace ControlDocs.Dao
{
    ...
    public partial class B1_OinmWithoutBinTransfer
    {
        ...
        public Nullable<decimal> InvPLInQty { get; set; }
        public Nullable<decimal> InvPLOutQty { get; set; }
        public Nullable<decimal> InvPLPrice { get; set; }
        public string InvPLCurrency { get; set; }
        public Nullable<decimal> InvPLRate { get; set; }
        public int InvPLLayerID { get; set; }
        public int InvPLMessageID { get; set; }
        public Nullable<int> InvPLSubLineNum { get; set; }
