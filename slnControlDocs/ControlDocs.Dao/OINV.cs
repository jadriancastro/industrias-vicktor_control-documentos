...
namespace ControlDocs.Dao
{
    ...
    public partial class OINV
    {
        ...
        public string U_Formulario { get; set; }
        public string U_FacNom { get; set; }
        public string U_Combo { get; set; }
        public string U_N_Pedido { get; set; }
        public string U_Transporte { get; set; }
        public string U_Mes_a_Declarar { get; set; }
        public Nullable<System.DateTime> U_Fecha_reten { get; set; }
        public string U_Sujeto { get; set; }
        public string U_RET_2 { get; set; }
        public string U_Num_Traslado { get; set; }
        public Nullable<System.DateTime> U_FacFecha { get; set; }
        public string U_Cod_Factura { get; set; }
        public string U_Cod_Doc { get; set; }
        public string U_SO1_01RETAILONE { get; set; }
        public string U_SO1_01FOLIORETAIL1 { get; set; }
        public string U_SO1_01REFERENCIAR1 { get; set; }
        public string U_SO1_01DEVDEFECTO { get; set; }
        public string U_FolioNC { get; set; }
        public string U_PrefijoFac { get; set; }
        public string U_Sucursal { get; set; }
        public string U_HoraFactura { get; set; }
        public string U_NumUnic { get; set; }
        public string U_EstaTrabajo { get; set; }
        public string U_Usuario { get; set; }
        public string U_PrefijoNC { get; set; }
        public Nullable<int> U_DiasMax { get; set; }
        public string U_RFC { get; set; }
        public Nullable<decimal> U_Retencion { get; set; }
        public string U_FacNIT { get; set; }
        public string U_SO1_02CANCELADO { get; set; }
        public string U_Referencia { get; set; }
        public string U_SO1_01CLIENTEALTER { get; set; }
        public Nullable<int> U_SO1_01FOLIOIMPRESO { get; set; }
        public string U_SO1_01PREFIJO { get; set; }
        public Nullable<decimal> U_SO1_01TOTALFISICO { get; set; }
        public string U_SO1_01ARCHIVOXML { get; set; }
        public string U_SO1_01ARCHIVOPDF { get; set; }
        public string U_SO1_02FECHATIMB { get; set; }
        public string U_FacReg { get; set; }
        public string U_FacNum { get; set; }
        public Nullable<decimal> U_IVA { get; set; }
        public Nullable<decimal> U_Percep { get; set; }
        public string U_Quedan { get; set; }
        public string U_Tipo_Venta { get; set; }
        public string U_TipoNC { get; set; }
        public string U_SO1_01SUCURSAL { get; set; }
        public string U_codigoESFA { get; set; }
        public string U_ConceptoNC { get; set; }
        public string U_ComentarioNC { get; set; }
        public string U_serieESFA { get; set; }
    }
}
